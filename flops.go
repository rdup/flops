...
func main() {
    fmt.Println(" ");
    fmt.Println("   FLOPS Go Program (double Precision), V0.1 23 Mar 2023")
...
*/
    ...
    //   dtime(TimeArray);
    dnulltime4 := time.Since(start4)
    timearray[1]=float64(dnulltime4)*1.0e-9
